...
- 🚀 **Currently Building:** Enterprise Lead Management (Alben.io), Real-Time Media Sync (RealSync), and a Multiplayer Gaming Hub (Replayhub).
- 💡 **Core Focus:** Progressive Web Apps (PWAs), Single Page Applications (SPAs), WebSockets, and Microservices.
...
| :--- | :--- | :--- |
| **Alben.io** <br>*(Enterprise SaaS)* | Next.js, Laravel, Tailwind, TypeScript, MySQL | Enterprise platform for lead management & workforce tracking with real-time data synchronization. |
| **RealSync** <br>*(Media Sync Platform)* | Next.js 15, NestJS, Socket.io, Redis, PWA | A highly scalable platform for synchronized, multi-user media streaming and interactive video sharing. |
| **Replayhub** <br>*(Gaming Hub)* | NestJS, Prisma, Socket.io, Nakama | Real-time multiplayer gaming hub powered by high-performance backend architecture. |
...
<details open> 
  ...
  <p>
      ...
      <img alt="Vitest" src="https://img.shields.io/badge/-Vitest-252529?logo=vitest&logoColor=FCC72B">
      <img alt="React Testing Library" src="https://img.shields.io/badge/-TestingLibrary-%23E33332?logo=testing-library&logoColor=white">
      <img alt="Cypress" src="https://img.shields.io/badge/-cypress-%23E5E5E5?logo=cypress&logoColor=058a5e">
  </p>
